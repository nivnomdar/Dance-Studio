...
const STYLES = {
  input: "w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-[#EC4899]/20 focus:border-[#EC4899] outline-none",
  inputError: "w-full px-4 py-2 border border-red-500 rounded-lg focus:ring-2 focus:ring-red-500/20 focus:border-red-500 outline-none",
  section: "bg-gradient-to-r from-[#EC4899]/5 to-[#4B2E83]/5 rounded-xl p-6",
  sectionAlt: "bg-gradient-to-r from-[#4B2E83]/5 to-[#EC4899]/5 rounded-xl p-6",
  button: "px-6 py-2 bg-gradient-to-r from-[#EC4899] to-[#4B2E83] text-white rounded-lg font-medium hover:from-[#4B2E83] hover:to-[#EC4899] transition-all duration-300",
  buttonSecondary: "px-6 py-2 bg-gray-100 text-[#4B2E83] rounded-lg font-medium hover:bg-gray-200 transition-all duration-300"
};
...
const getInputClassName = (fieldName: string, errors: Record<string, string>): string => {
        ...
        <div className="overflow-y-auto max-h-[calc(95vh-140px)]">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className={getInputClassName('start_time', errors)}
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    className={getInputClassName('end_time', errors)}
                  />
          ...
          <div className={STYLES.section}>
            ...
            <div className="bg-white rounded-lg p-4 mb-4 border border-[#EC4899]/20">
              <h4 className="text-sm font-semibold text-[#4B2E83] mb-3">הוסף שיעור לקבוצה</h4>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-[#4B2E83]/60 mt-1 leading-relaxed">
                      שיעור מוזל או חינמי עם הגבלת שימושים למשתמש חדש. 
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="px-4 py-2 bg-gradient-to-r from-[#EC4899] to-[#4B2E83] text-white rounded-lg font-medium hover:from-[#4B2E83] hover:to-[#EC4899] transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed text-sm"
                  >
                    הוסף
                  </button>
                </div>
              ...
              {selectedClassId && (
                <div className="mt-3 p-3 bg-gray-50 rounded-lg">
                  <div className="text-xs text-[#4B2E83]/70">
                    <strong>שיעור נבחר:</strong> {classes.find(c => c.id === selectedClassId)?.name}
                    <br />
                    <strong>מחיר:</strong> ₪{classes.find(c => c.id === selectedClassId)?.price || 0}
                  </div>
                </div>
              )}
              ...
              {isTrialClass && (
                <div className="mt-3">
                  <label className="block text-xs font-medium text-[#4B2E83] mb-1">מקסימום שימושים למשתמש</label>
                  <input
                    type="number"
                  ...
                  <p className="text-xs text-[#4B2E83]/60 mt-1">
                    מספר הפעמים המקסימלי שמשתמש יכול להירשם לשיעור ניסיון זה. 
                    לדוגמה: 1 = שימוש חד פעמי, 2 = שני שימושים לכל משתמש.
                  </p>
                </div>
              )}
            </div>
                ...
                linkedClasses.map((linkedClass, index) => (
                  <div key={linkedClass.class_id} className="bg-white rounded-lg p-4 border border-[#EC4899]/20 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h4 className="font-medium text-[#4B2E83]">{getClassName(linkedClass.class_id)}</h4>
          ...
          <div className="flex justify-end gap-3 pt-6 border-t border-gray-200">
              ...
              <button
                type="submit"
                disabled={isLoading}
                className={`${STYLES.button} disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2`}
              >
                {isLoading ? (
                  <>
                  ...
                  <>
                    ...
                    {isEditingSession(sessionData) ? 'עדכן קבוצה' : 'צור קבוצה'}
                  </>
                )}
              </button>
            </div>
