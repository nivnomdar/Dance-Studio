        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12">
          ...
          <div className="bg-white p-4 sm:p-6 lg:p-8 rounded-lg shadow-lg">
            <form className="space-y-4 sm:space-y-6" onSubmit={handleSubmit}>
              ...
              <div>
                <label htmlFor="email" className="block text-xs sm:text-sm font-medium text-[#2B2B2B] mb-1.5 sm:mb-2">
                  אימייל
                </label>
                <input
                  type="email"
              ...
              <div>
                <label htmlFor="phone" className="block text-xs sm:text-sm font-medium text-[#2B2B2B] mb-1.5 sm:mb-2">
                  טלפון
                </label>
                <input
                  type="tel"
              ...
              <div>
                <label htmlFor="message" className="block text-xs sm:text-sm font-medium text-[#2B2B2B] mb-1.5 sm:mb-2">
                  הודעה
                </label>
                <textarea
                  id="message"
          ...
          <div className="space-y-6 sm:space-y-8">
              ...
              <div className="space-y-3 sm:space-y-4">
                ...
                <div className="space-y-3 sm:space-y-4">
                  <p className="flex items-start sm:items-center text-[#2B2B2B] text-sm sm:text-base">
                    <svg className="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 text-[#D8A7B1] mr-2 sm:mr-3 flex-shrink-0 mt-0.5 sm:mt-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <p className="flex items-center text-[#2B2B2B] text-sm sm:text-base">
                    <svg className="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 text-[#D8A7B1] mr-2 sm:mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <p className="flex items-center text-[#2B2B2B] text-sm sm:text-base">
                    ...
                    <span className="mr-2 break-all">info@avigaildance.com</span>
                  </p>
                </div>
              </div>
            </div>
            ...
            >
              <div className="flex items-center justify-center mb-2 sm:mb-3">
                <svg className="w-6 h-6 sm:w-7 sm:h-7 lg:w-8 lg:h-8 text-[#EC4899] animate-bounce mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-[#4B2E83] font-agrandir-grand relative">
                  עקבי אחרינו
                  <span className="block w-12 sm:w-14 lg:w-16 h-1 bg-gradient-to-r from-[#EC4899] to-[#E6C17C] rounded-full mt-1 sm:mt-2 mx-auto"></span>
                </h3>
              </div>
              <div className="flex flex-wrap gap-3 sm:gap-4 justify-center mt-3 sm:mt-4">
                ...
                >
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full flex items-center justify-center mb-1.5 sm:mb-2 group-hover:shadow-pink-300 group-hover:shadow-lg transition-all duration-300 ring-2 ring-[#EC4899]/30 group-hover:ring-4 group-hover:ring-[#EC4899]/50">
                    <svg className="w-5 h-5 sm:w-6 sm:h-6 text-white drop-shadow-glow" fill="currentColor" viewBox="0 0 24 24">
