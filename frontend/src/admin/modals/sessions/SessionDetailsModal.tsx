    ...
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-2 sm:p-4">
      <div className="bg-white rounded-2xl sm:rounded-3xl w-full max-w-[95vw] sm:max-w-6xl max-h-[95vh] overflow-hidden shadow-2xl">
        ...
        <div className="overflow-y-auto max-h-[calc(95vh-140px)]">
          ...
          <div className="p-3 sm:p-6 bg-gradient-to-r from-[#EC4899]/5 to-[#4B2E83]/5 border-b border-gray-100">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
              <div className="bg-white rounded-xl p-2 sm:p-4 text-center shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                <div className="text-lg sm:text-2xl font-bold text-[#4B2E83] mb-1">
              ...
              <div className="bg-white rounded-xl p-2 sm:p-4 text-center shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                <div className="text-lg sm:text-2xl font-bold text-[#EC4899] mb-1">
                  {occupancyRate.toFixed(1)}%
                </div>
                <div className="text-xs sm:text-sm text-[#4B2E83]/70">תפוסה</div>
              ...
              <div className="bg-white rounded-xl p-2 sm:p-4 text-center shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                ...
                <div className="text-xs sm:text-sm text-[#4B2E83]/70">תפוסה מקסימלית</div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div className="space-y-2">
                <div className="bg-gray-50 p-3 sm:p-4 rounded-lg">
                  <h4 className="font-semibold text-[#4B2E83] mb-2 flex items-center gap-2 text-sm sm:text-base">
                    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-12a1 1 0 10-2 0v4a1 1 0 00.293.707l2.828 2.829a1 1 0 101.415-1.415L11 9.586V6z" clipRule="evenodd" />
                    </svg>
                    זמני פעילות
                  ...
                  <div className="flex flex-wrap gap-1 sm:gap-2">
                    {weekdays.length > 0 ? (
                      weekdays.map((day: string, index: number) => (
                        <span key={index} className="inline-flex items-center px-2 sm:px-3 py-1 rounded-full text-xs sm:text-sm font-medium bg-[#4B2E83]/10 text-[#4B2E83]">
                          {day}
                        </span>
                      ))
                    ) : (
                      <span className="text-[#4B2E83]/50 text-xs sm:text-sm">לא מוגדר</span>
                    )}
                  </div>
                </div>
              </div>
