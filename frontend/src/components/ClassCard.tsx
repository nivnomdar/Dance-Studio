  ...
  return (
    ...
    >
      ...
      <div className="p-6 flex flex-col h-full pt-6">
        <h3 className={`text-xl font-bold ${colorScheme.textColor} mb-3 font-agrandir-grand line-clamp-2`}>
          {classItem.name}
        </h3>

        <div className="h-20 mb-4">
          <p className="text-[#2B2B2B] font-agrandir-regular leading-relaxed text-sm line-clamp-3">
