    ...
    <section className="relative py-20 bg-black overflow-hidden">
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="text-lg md:text-xl text-white/90 font-agrandir-regular leading-relaxed mb-6">
          התחלתי את דרכי בעולם הבלט והסלונים בגיל 13, ובהמשך הצטרפתי ללהקת היפ הופ והתחרתגווןתי בתחרויות בישראל. לפני שנתיים גיליתי את ריקוד העקב – ומאז פיתחתי סגנון ייחודי משלי.
        </p>
